...
public class SamsungAdapter extends RecyclerView.Adapter<SamsungAdapter.ViewHolderAdapter> {

    private ArrayList<ProdukModel> produkModelList;
    private Context context;

    public SamsungAdapter(ArrayList<ProdukModel> produkModelList, Context context) {
