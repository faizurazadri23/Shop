...
public class VivoAdapter extends RecyclerView.Adapter<VivoAdapter.ViewHolderAdapter> {

    private ArrayList<ProdukModel> produkModelList;
    private Context context;

    public VivoAdapter(ArrayList<ProdukModel> produkModelList, Context context) {
