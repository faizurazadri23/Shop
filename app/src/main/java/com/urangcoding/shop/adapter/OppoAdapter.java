...
public class OppoAdapter extends RecyclerView.Adapter<OppoAdapter.ViewHolderAdapter> {

    private ArrayList<ProdukModel> produkModelList;
    private Context context;

    public OppoAdapter(ArrayList<ProdukModel> produkModelList, Context context) {
